    ...
    public function getAll()
    {
        ...
        foreach ($cobros as $cobro) {
            ...
            $actionButton = '<div class=" action-buttons center">
                     ...
                     <a class="text-success" target="_blank" href="' . route('Director.Cobro.Print', ['caja' => $cobro]) . '"   >
...
<i class="ace-icon fas fa-print bigger-110 "></i>
    ...
    {
        return view('director.contabilidad.cobro.index', ['alumnos' => Alumno::all()]);
    }
    ...
    {
        return view('director.contabilidad.cobro.create', ['alumnos' => Alumno::all()]);
    }
    ...
    public function store(Request $request)
    {
        ...
        return response()->json(['message' => 'Registro agregado correctamente', 'print' => ' <a class="btn btn-app btn-default my-1 text-white"  onclick="invoice(' . "'" . route('Director.Cobro.Invoice', ['id' => $cobro->id, 'print' => 1]) . "'" . ')">
...
//return SnappyImage::loadView('admin.pago.reportes.pdf')->setOption('quality', 100)->inline();
    ...
    public function printInvoice($caja)
    {
        ...
        return PDF::loadView('director.contabilidad.reportes.invoice',
         ['pago' => Cobro::find($caja), 'info' => Info::find(1)])->setOption('footer-html', $footer)
         ->setOption('enable-javascript', true)->setOption('footer-right', 'Página [page] de [topage]')
