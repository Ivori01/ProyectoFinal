<div class="navbar-nav">
    <ul class="nav">
        ...
        {{-- <li class="nav-item"><a class="nav-link dropdown-toggle"
                href="{{ route('home') }}">Intranet</a></li> --}}
        {{-- <li class="nav-item dropdown dropdown-mega">
            <a aria-expanded="false" aria-haspopup="true" class="nav-link dropdown-toggle" data-toggle="dropdown"
                href="http://104.237.146.83/templates/ace/demo/#" role="button">
            ...
            <div
                class="p-0 dropdown-menu dropdown-animated bgc-light-m1 brc-primary-m2 border-t-0 border-x-1 border-b-2 ace-scrollbar">
                <div class="row mx-0">
                    <div class="col-lg-4 col-12 p-2 p-lg-3 p-xl-4 d-flex align-items-center">
                        <div class="list-group mt-3 mx-auto px-0">
                            <a class="list-group-item list-group-item-action"
                                href="http://104.237.146.83/templates/ace/demo/#">
                            ...
                            <a class="list-group-item list-group-item-action bgc-success-l1 bgc-h-success-l2"
                                href="http://104.237.146.83/templates/ace/demo/#">
                    ...
                    <div class="col-lg-4 col-12 p-4 dropdown-clickable">
                        ...
                        <form class="my-3">
                            ...
                            <div class="form-group mb-4">
                                <textarea class="form-control brc-primary-m2 border-l-2 text-grey-d1"
        ...
        <li class="nav-item dropdown dropdown-mega">
            <a aria-expanded="false" aria-haspopup="true" class="nav-link dropdown-toggle pl-lg-3 pr-lg-4"
                data-toggle="dropdown" href="http://104.237.146.83/templates/ace/demo/#" role="button">
                ...
                <!-- show only on mobile -->
                <span class="badge badge-sm badge-warning radius-round text-80 border-1 brc-white-tp5"
                    id="id-navbar-badge1">
                    3
                </span>
                <i class="caret fa fa-angle-left d-block d-lg-none">
            ...
            <div
                class="shadow dropdown-menu dropdown-animated dropdown-sm p-0 bg-white brc-primary-m3 border-1 border-b-2">
                <ul
                    class="nav nav-tabs nav-tabs-simple w-100 nav-justified dropdown-clickable border-b-1 brc-default-m4">
                    <li class="nav-item">
                        <a class="d-style px-0 mx-0 py-3 nav-link active text-600 brc-blue-m2 text-grey-m3 bgc-h-blue-l4"
                            data-toggle="tab" href="http://104.237.146.83/templates/ace/demo/#navbar-notif-tab-1"
                            role="tab">
                    ...
                    <li class="nav-item">
                        <a class="d-style px-0 mx-0 py-3 nav-link text-600 brc-purple-m2 text-grey-m3 bgc-h-purple-l4"
                ...
                <div class="tab-content tab-sliding p-0">
                    <div class="tab-pane mh-none show active px-md-1 pt-1" id="navbar-notif-tab-1" role="tabpanel">
                        <a class="mb-0 border-0 list-group-item list-group-item-action btn-h-lighter-secondary"
                            href="http://104.237.146.83/templates/ace/demo/#">
                        ...
                        <a class="mb-0 py-3 border-0 list-group-item text-blue-m2 text-uppercase text-center text-85 font-bold"
                            href="http://104.237.146.83/templates/ace/demo/#">
                    ...
                    <div class="tab-pane mh-none pl-md-2" id="navbar-notif-tab-2" role="tabpanel">
                        <div ace-scroll='{"ignore": "mobile", "height": 300, "smooth":true}'
                            class="ace-scroll ace-scroll-wrap" style="max-height: 300px;">
                            <div class="ace-scroll-inner" style="color: rgb(33, 37, 41);">
                                <a class="d-flex mb-0 border-0 list-group-item list-group-item-action btn-h-lighter-secondary"
                                    href="http://104.237.146.83/templates/ace/demo/#">
                                    <img class="align-self-start border-2 brc-primary-m3 p-1px mr-2 radius-round"
                                        src="./Gallery - Ace Admin_files/avatar.png" width="48">
                                    <div>
                                ...
                                <a class="d-flex mb-0 border-0 list-group-item list-group-item-action btn-h-lighter-secondary"
                                    href="http://104.237.146.83/templates/ace/demo/#">
                                    <img class="align-self-start border-2 brc-primary-m3 p-1px mr-2 radius-round"
                                        src="./Gallery - Ace Admin_files/avatar3.png" width="48">
                                    <div>
                                        <span class="text-blue-m1 font-bolder">
                                            Susan:
                                        </span>
                                ...
                                <a class="d-flex mb-0 border-0 list-group-item list-group-item-action btn-h-lighter-secondary"
                                    href="http://104.237.146.83/templates/ace/demo/#">
                                    <img class="align-self-start border-2 brc-primary-m3 p-1px mr-2 radius-round"
                                        src="./Gallery - Ace Admin_files/avatar4.png" width="48">
                                    <div>
                                        <span class="text-blue-m1 font-bolder">
                                            Bob:
                                        </span>
                                ...
                                <a class="d-flex mb-0 border-0 list-group-item list-group-item-action btn-h-lighter-secondary"
                                    href="http://104.237.146.83/templates/ace/demo/#">
                                    <img class="align-self-start border-2 brc-primary-m3 p-1px mr-2 radius-round"
                                        src="./Gallery - Ace Admin_files/avatar2.png" width="48">
                                    <div>
                                        <span class="text-blue-m1 font-bolder">
                                            Kate:
                                        </span>
                                ...
                                <a class="d-flex mb-0 border-0 list-group-item list-group-item-action btn-h-lighter-secondary"
                                    href="http://104.237.146.83/templates/ace/demo/#">
                                    <img class="align-self-start border-2 brc-primary-m3 p-1px mr-2 radius-round"
                                        src="./Gallery - Ace Admin_files/avatar5.png" width="48">
                                    <div>
                                        <span class="text-blue-m1 font-bolder">
                                            Fred:
                                        </span>
                        ...
                        <a class="mb-0 py-3 border-0 list-group-item text-blue-m2 text-uppercase text-center text-85 font-bold"
                            href="http://104.237.146.83/templates/ace/demo/html/inbox.html">
                            See All Messages
                            <i class="ml-2 fa fa-arrow-right text-muted">
                            </i>
                        </a>
        ...
        <li class="nav-item dd-backdrop dropdown dropdown-mega">
            ...
            <div
                class="shadow dropdown-menu dropdown-animated animated-1 dropdown-xs p-0 bg-white brc-warning-l1 border-x-1 border-b-1">
                ...
                <div class="px-4 py-2">
                    ...
                    <div class="progress mt-2">
                        <div aria-valuemax="100" aria-valuemin="0" aria-valuenow="60" class="progress-bar bgc-info"
                ...
                <div class="px-4 py-2">
                    ...
                    <div class="progress mt-2">
                        <div aria-valuemax="100" aria-valuemin="0" aria-valuenow="60" class="progress-bar bgc-warning"
                ...
                <div class="px-4 py-2">
                    ...
                    <div class="progress mt-2">
                        <div aria-valuemax="100" aria-valuemin="0" aria-valuenow="60" class="progress-bar bgc-danger"
                ...
                <div class="px-4 py-2">
                    ...
                    <div class="progress mt-2">
                        <div aria-valuemax="100" aria-valuemin="0" aria-valuenow="60"
                            class="progress-bar bgc-success progress-bar-striped progress-bar-animated"
                ...
                <a class="d-block bgc-h-primary-l4 py-3 border-0 text-center text-blue-m2"
                    href="http://104.237.146.83/templates/ace/demo/#">
        ...
        <li class="nav-item dropdown order-first order-lg-last">
            <a aria-expanded="false" aria-haspopup="true" class="nav-link dropdown-toggle" data-toggle="dropdown"
                href="#" role="button">
                <img alt="Photo" class="d-none d-lg-inline-block radius-round border-2 brc-white-tp1 mr-2"
                    id="id-navbar-user-image"
                    src="{{ url(Storage::url('sistem/photos/' . Auth::user()->persona->foto)) }}" width="36"
                    height="36">
            ...
            <div class="dropdown-menu dropdown-caret dropdown-menu-right dropdown-animated brc-primary-m3">
                ...
                <a class="dropdown-item btn btn-outline-grey btn-h-lighter-primary btn-a-lighter-primary"
