<div class="alert bgc-white text-dark-tp3 border-1 brc-secondary-l2 shadow-sm radius-0 py-3 d-flex align-items-start ml-2">
    ...
    <a aria-label="Close" class="close align-self-start ml-auto mt-n25 mr-n2 text-blue-d2 text-150 opacity-2 bgc-h-blue-l2 radius-round px-15 pt-1px pb-3px"  href="{{ route('Alumno.Evaluacion.StartPreview',['evaluacion'=>$examen]) }}">
