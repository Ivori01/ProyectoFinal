...
<div btn-id="#btn-tab-{{ $idCard }}" class="card bgc-{{ $class}}-m1 mb-3" id="card-{{ $idCard }}">
    ...
    <div class="card-footer px-4 py-3 brc-dark-l3 d-flex justify-content-between ">
        <p class="pr-2 mr-2 text-bold font-weight-bold text-white text-110">Comentario:</p>
       <p class="text-white">{{$intento_question->resultado->comentario}}</p>
</div>
<!-- /.card-body -->
