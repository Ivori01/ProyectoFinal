<div class="navbar-nav">
    <ul class="nav">
        {!!  $li ?? ''!!}
        <li class="nav-item"><a  class="nav-link dropdown-toggle" href="{{ route('home') }}">Intranet</a></li>
       {{--  <li class="nav-item dropdown dropdown-mega">
        ...
        <li class="nav-item dropdown order-first order-lg-last">
            <a aria-expanded="false" aria-haspopup="true" class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button">
                <img alt="Photo" class="d-none d-lg-inline-block radius-round border-2 brc-white-tp1 mr-2" id="id-navbar-user-image" src="{{ url(Storage::url('sistem/photos/'.Auth::user()->persona->foto))}}" width="36">
            ...
            <div class="dropdown-menu dropdown-caret dropdown-menu-right dropdown-animated brc-primary-m3">
                ...
                <a class="dropdown-item btn btn-outline-grey btn-h-lighter-success btn-a-lighter-success" data-target="#id-ace-settings-modal" data-toggle="modal" href="#">
                ...
                <a class="dropdown-item btn btn-outline-grey btn-h-lighter-secondary btn-a-lighter-secondary" href="{{ route('logout') }}"
