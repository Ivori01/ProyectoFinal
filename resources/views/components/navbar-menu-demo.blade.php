<div class="navbar-nav">
    <ul class="nav">
        ...
        <li class="nav-item dropdown dropdown-mega">
            ...
            <div class="shadow dropdown-menu dropdown-animated dropdown-sm p-0 bg-white brc-primary-m3 border-1 border-b-2">
                <ul class="nav nav-tabs nav-tabs-simple w-100 nav-justified dropdown-clickable border-b-1 brc-default-m4">
                    ...
                    <li class="nav-item">
                        <a class="d-style px-0 mx-0 py-3 nav-link text-600 brc-purple-m2 text-grey-m3 bgc-h-purple-l4" data-toggle="tab" href="http://104.237.146.83/templates/ace/demo/#navbar-notif-tab-2" role="tab">
        ...
        <li class="nav-item dropdown order-first order-lg-last">
            <a aria-expanded="false" aria-haspopup="true" class="nav-link dropdown-toggle" data-toggle="dropdown" href="http://104.237.146.83/templates/ace/demo/#" role="button">
                <img alt="Jason's Photo" class="d-none d-lg-inline-block radius-round border-2 brc-white-tp1 mr-2" id="id-navbar-user-image" src="./Gallery - Ace Admin_files/user.jpg">
            ...
            <div class="dropdown-menu dropdown-caret dropdown-menu-right dropdown-animated brc-primary-m3">
                ...
                <a class="dropdown-item btn btn-outline-grey btn-h-lighter-success btn-a-lighter-success" data-target="#id-ace-settings-modal" data-toggle="modal" href="http://104.237.146.83/templates/ace/demo/#">
                ...
                <a class="dropdown-item btn btn-outline-grey btn-h-lighter-secondary btn-a-lighter-secondary" href="http://104.237.146.83/templates/ace/demo/html/page-login.html">
