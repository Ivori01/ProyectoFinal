@extends('layouts.ace',['title'=>'Docente | Home','bg_body'=>'content-bg1'])
            ...
            <div class="mb-1">
                <a href="{{route('Docente.AulaVirtual.Index')}}">
                    <span class="d-inline-block bgc-purple-l2 p-3 radius-round">
                        <i class="fas fa-graduation-cap text-purple-m1 text-180 w-4">
                        </i>
                    </span>
                </a>
            </div>
                            ...
                            <table class="table table-bordered table-striped">
                                ...
                                <tbody>
                                   ...
                                   <td>
                                        ...
                                        <td>
                                            {{$curso->seccionInfo->datosGrado->numero .'° ' .$curso->seccionInfo->letra}}
                                        </td>
                                        <td>
                                            {{ $curso->seccionInfo->datosAnioNivel->datosAnio->anio}}
                                        </td>
                                    </tr>
