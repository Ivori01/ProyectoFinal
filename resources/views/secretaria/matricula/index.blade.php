@extends('layouts.ace',['title'=>'Secretaria | Matriculas'])
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-9 col-12 tag-input-style">
                  <select  class="select2 form-control " data-placeholder="Seleccione" name="id_seccion"  >
                   ...
                   <option value="{{$seccion->id}}">{{$seccion->datosGrado->nombre .' - '.$seccion->letra .' - '.$seccion->datosGrado->DatosNivel['nombre']}} ( {{$anio->anio}} )</option>  
                   @endforeach	 
                   @endforeach
...
@component('components.js.select-search',['name'=>'#alumno','ruta'=>route('Secretaria.Alumno.Search')])
 ...
 @component('components.js.b-table',['route'=>route('Secretaria.Matricula.Retrieve')])
        @endcomponent
