@extends('layouts.ace',['title'=>'Secretaria | Caja','headertitle'=>'Home'])
                        ...
                        <div class="d-none" id="smartwizard-1">
                            ...
                            <div class="px-2 py-2 mb-4">
                                    ...
                                    <form id="form-deudas" novalidate="">
                                        <input id="token" name="_token" type="hidden" value="{{ csrf_token() }}">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9 col-12 tag-input-style">
                                                    <select class="select2 " data-placeholder="Seleccione ..." multiple="" name="descuento[]" onchange="getTable();">
                                ...
                                <div class="text-center" id="step-3">
                                    <h3 class="font-light text-blue my-4">
                                        Imprimir comprobante de pago
                                    </h3>
                                    <div class="col-sm-5 mx-auto d-block btn-group btn-group-toggle" data-toggle="buttons" id="show-print">
                                    </div>
                                </div>
                            </div>
                        </div>
...
<div class="row">
    <div class="col-12">
        @component('components.ace-table',['title'=>'Deudas pagadas'])
...
<script type="text/javascript">
    ...
    jQuery(function($) {
        ...
        @component('components.js.select-search', ['name' => '#alumno-search', 'ruta' => route('Secretaria.Caja.Alumno.Search')])
        @endcomponent
        ...
        @component('components.js.b-table', ['route' => route('Secretaria.Caja.Retrieve')])
        @endcomponent
    })
