@extends('layouts.ace',['title'=>'Secretaria | Alumno'])
             ...
             <div class="form-group row">
          	...
          	<option value=''></option>	
				...
				@endforeach
                 ...
                 <div class="form-group row">
                <div class="col-sm-3 col-form-label text-sm-right pr-0">
                  <label for="state">Apoderado :</label>
                </div>

                <div class="col-sm-9 col-12 tag-input-style">
                  <select  class="select2 form-control " data-placeholder="Seleccione"name="apoderado" id="apoderado">
...
$.ajax({
    ...
    data:{q:{{$alumno->datosApoderado->persona->nrodocumento}} }
}).then(function (data) {
console.log(data);
      ...
      @slot('rules')
       ...
       @slot('submitHandler')
		...
		@component('components.js.ajax')
		    ...
		    @slot('url')
				'{{ route("Secretaria.Alumno.Update",["alumno"=>"$Persona->id"]) }}'
			@endslot
	        @slot('data')
				formData
			@endslot
