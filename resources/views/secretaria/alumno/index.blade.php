@extends('layouts.ace',['title'=>'Secretaria | Alumnos'])
...
@section('content')
	...
	@component('components.ace-table',['title'=>'Alumnos'])
		...
		<th >Imagen</th>
		<th data-sortable="true">Estado Academico</th>
		<th>Carnet</th>
		<th>Acciones</th>
	@endcomponent               
...
<script src="{{ asset('assets/js/bootstrap-table.min.js')}}" type="text/javascript">
  ...
  $('#alumno-todos').addClass('active');  
		...
		@component('components.js.b-table',['route'=>route('Secretaria.Alumno.Retrieve')])
		@endcomponent
