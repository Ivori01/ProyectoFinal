    ...
    <div class="col-12">
        ...
        <input id="token" name="_token" type="hidden" value="{{ csrf_token() }}">
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <select class="select2 col-xs-4 col-sm-4" data-placeholder="Seleccione" id="apoderado" name="apoderado">
                    </select>
                </div>
            </div>
           ...
           @slot('toolbarCard')
            ...
            <input name="_token" type="hidden" value="{{ csrf_token() }}">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <select class="select2 col-xs-4 col-sm-4" data-placeholder="Seleccione" id="apoderado2" name="apoderado">
                        </select>
                    </div>
                </div>
                <input hidden="" name="estadoacademico" type="text" value="Estudiando">
...
@component('components.js.validator-check',['MethodName'=>'checkalumno','RutaCheck'=>route('Secretaria.Alumno.Check'),'data'=>"{_token:token,nrodocumento : value,model:'alumno' }"])
@endcomponent
