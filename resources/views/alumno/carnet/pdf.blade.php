...
<body class=''>
    <div class='card'>
        <header>
            <h1>Carnet  del alumno</h1>
        </header>
        <article>
            <img alt='My Pic' id='thumb'
                src="{{ url(Storage::url('sistem/photos/'.$alumno->persona->foto))}}">
            <h2>{{$alumno->persona->nombres_apellidos}}</h2>
            <div class='area'>
                <h3>{{$alumno->persona->nrodocumento}}</h3>
               
                <h2>{{$alumno->persona->direccion}}</h2>
                
                <h2>{{$alumno->persona->celular}}</h2>
