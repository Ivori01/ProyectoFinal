@extends('layouts.ace',['title'=>'Director | Plan academico','headertitle'=>'Home','viewtitle'=>'Panel Principal','page'=>'Home'])
...
<div class="row">
    <div class="col-12">
        @component('components.ace-table',['title'=>'Planes academicos'])
...
<script src="{{ asset('assets/js/initinput.js')}}">
 ...
 @component('components.js.b-table',['route'=>route('Director.PlanAcademico.Retrieve')])
        @endcomponent
