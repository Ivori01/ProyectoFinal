@extends('layouts.ace',['title'=>'Director | Ver perfil de los docentes'])
        ...
        <div class="tab-content px-0 tab-sliding border-1 flex-grow-1 radius-b-2 border-t-0 brc-grey-l2">
            <div class="tab-pane show px-1 px-md-2 px-lg-3 active" id="profile-tab-overview">
			 ...
			 @endphp
                                        ...
                                        <tr>
                                            <td>
                                                <i class="fas fa-sitemap text-secondary-m3">
                                                </i>
                                            </td>
                                            <td class="text-95 text-default-d3">
                                              Nivel
                                            ...
                                            <td class="text-secondary-d2">
                                             @foreach ($Docente->niveles as $nivel)
                                                 <li>{{$nivel->datosNivel->nombre}}</li>
                                             @endforeach 
                                            </td>
                                        </tr>
                                             <tr>
                                            <td>
                                                <i class="fa fa-user-circle text-secondary-m3">
                                                </i>
                                            </td>
                                            <td class="text-95 text-default-d3">
                                              Especialidad 
...
$('#menu-persona').addClass('active open');
  ...
  $('#docente-show').addClass('active').removeClass('d-none');
