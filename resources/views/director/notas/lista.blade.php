...
<script type="text/javascript">
  ...
  $('#menu-reporte-lista').addClass('active');
  

   
       @component('components.js.select-search',['name'=>'#alumno','ruta'=>route('Director.Alumno.SearchAll')])
  ...
  focusConfirm: false,
   showConfirmButton: false,
    ...
    function getGrades(alumno) {
       $("#matricula").empty();
         $.ajax({
        url: '{{ route('Director.Alumno.Grados') }}',
        data:{persona:alumno},
        dataType:'json',
        beforeSend: function(){ 
