@extends('layouts.ace',['title'=>'Director | Editar informacion del alumno'])
        ...
        <input id="token" name="_token" type="hidden" value="{{ csrf_token() }}">
             ...
             <div class="form-group row">
          	...
          	<option value=''></option>	
				...
				<option value='{{$estado}}' @if ($estado == $alumno->estadoacademico) selected=""  @endif>{{$estado}}</option>
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <select name="nivel_id" class="select2">
                        ...
                        <option value="{{$nivel->id}}" @if($alumno->nivel_id==$nivel->id)
                          selected
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                   <input type="text" name="dni_padre" class="form-control" value="{{$alumno->dni_padre}}">
                </div>
            </div>
            <div class="form-group row">
                <div class="col-sm-3 col-form-label text-sm-right pr-0">
                ...
                <div class="col-sm-9">
                   <input type="text" name="nombre_padre" class="form-control" value="{{$alumno->nombre_padre}}">
                </div>
            </div>
            <div class="form-group row">
                <div class="col-sm-3 col-form-label text-sm-right pr-0">
                ...
                <div class="col-sm-9">
                   <input type="text" name="telefono_padre" value="{{$alumno->telefono_padre}}" class="form-control">
                </div>
            </div>
                @endslot
...
<script src="{{ asset('assets/js/initinput.js')}}">
  ...
  $('#alumno-edit').addClass('active').removeClass('d-none');
      ...
      @slot('rules')
       ...
       @slot('submitHandler')
		...
		@component('components.js.ajax')
		    ...
		    @slot('url')
				'{{ route("Director.Alumno.Update",["alumno"=>"$alumno->id"]) }}'
			@endslot
	        @slot('data')
				formData
			@endslot
