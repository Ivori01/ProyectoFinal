@extends('layouts.ace',['title'=>'Director | Registar secretaria'])
...
<div aria-hidden="true" aria-labelledby="exampleModalLabel" class="modal fade" id="modal-registro" role="dialog" tabindex="-1">
    <div class="modal-dialog " role="document">
        <div class="modal-content">
            @component('components.card-form',['cardId'=>'widget2','formId'=>'form-create2','color'=>'bgc-primary'])
          @slot('titleCard')
          Formulario de registro
          @endslot
           @slot('toolbarCard')
...
@component('components.js.validator-check',['MethodName'=>'checksecretaria','RutaCheck'=>route('Director.Secretaria.Check'),'data'=>"{_token:token,nrodocumento : value,model:'secretaria' }"])
@endcomponent
      ...
      @slot('rules')
		...
		nrodocumento: {required: true,number:true,  checksecretaria: true, checkpersona:true }, 
...
Swal.fire({
  ...
  timer: 2500
	...
	@component('components.js.validate-form')
		...
		@slot('rules')
		nrodocumento: {required: true, number:true,  checksecretaria: true }
		@endslot
