@extends('layouts.ace',['title'=>'Director | Directores','headertitle'=>'Home','viewtitle'=>'Panel Principal','page'=>'Home'])
...
<div class="row">
    <div class="col">
        @component('components.ace-table',['title'=>'Directores'])
...
@section('script')
  ...
  $('#director-todos').addClass('active');  
		 ...
		 @component('components.js.b-table',['route'=>route('Director.Director.Retrieve')])
    @endcomponent
