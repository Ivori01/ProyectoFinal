@extends('layouts.ace',['title'=>'Director | Registrar director'])
...
<script src="{{ asset('assets/js/initinput.js')}}">
  ...
  $('#menu-director').children('.submenu').addClass('show');
...
@component('components.js.validator-check',['MethodName'=>'checkdirector','RutaCheck'=>route('Director.Director.Check'),'data'=>"{_token:token,nrodocumento : value,model:'director' }"])
@endcomponent
	...
	@component('components.js.validate-form')
      ...
      @slot('rules')
		...
		nrodocumento: {required: true,number:true,  checkdirector: true, checkpersona:true }, 
...
Swal.fire({
  ...
  timer: 2500
	...
	@component('components.js.validate-form')
		...
		@slot('rules')
		nrodocumento: {required: true, number:true, checkdirector: true }
