                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <div class="input-group date datetimepicker w-50">
                                    <input class="form-control w-75" name="fechavencimiento" type="text" data-date-format="YYYY-MM-DD">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <div class="input-group date datetimepicker w-50" id="id-timepicker">
                                    <input class="form-control w-75" id="fechavencimientoU" name="fechavencimiento" data-date-format="YYYY-MM-DD" type="text">
                                    <div class="input-group-addon input-group-append">
                                        <div class="input-group-text">
                                            <i class="far fa-clock">
                                            </i>
